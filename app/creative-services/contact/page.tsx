        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl animate-slide-up">
              <CardHeader>
                <CardTitle className="text-2xl text-purple-600">Let's Create Together</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <p className="text-gray-700 text-lg">
                  Ready to bring your creative vision to life? I'd love to discuss your project and explore how we can
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">robel.creative@email.com</p>
                    </div>
                  </div>
            ...
            <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl animate-slide-up delay-200">
              <CardHeader>
                <CardTitle className="text-2xl text-purple-600">Connect With Me</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <p className="text-gray-700">
                  Let's connect on your preferred platform and start discussing your creative project needs.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <a href="mailto:robel.creative@email.com" className="group">
